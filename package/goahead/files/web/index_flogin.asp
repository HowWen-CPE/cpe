...
function initTranslation()
{
	...
	e.value = _("login continue");
	e = document.getElementById("Cancel");
	e.value = _("login cancel");
  ...
  e = document.getElementById("modelname");
	...
	e = document.getElementById("flogintitle");
	e.innerHTML = _("force login title");
	e = document.getElementById("lloginmsg");
	e.innerHTML = _("force loginmsg");
...
function loadfocus()
{
	document.web_login.Continue.focus();
}

function force_Login(n) {
	if (n==1) {
		self.location.href = "/force_login.html";
	} else {
...
<body onLoad="initValue();loadfocus();">
...
<div class="home_note">
  <ul>
<li class="welcome_text" id="flogintitle">User already logged in.</li>
<li class="welcome_text"><font color="#FF0000" id="lloginmsg">If you want to close the other session, please click on 'Continue' button. Click 'Cancel' Button to Logout</font></li>
<li>
...
<!--
	...
	<td><div><ul><li class="button3"><input type="hidden" name="set_flag" size="1" value="0"><span><input type="submit" id=manlogin onClick="document.web_login.submit()"/></span></li></ul></div></td>
-->
	  <td colspan="2">
		<span class="button3"><input type="button" value="Continue" id="Continue" onclick='force_Login(1)'/></span>&nbsp;&nbsp;
		<span class="button3"><input type="button" value="Cancel" id="Cancel" onClick='force_Login(0)'/></span>
  	  <td>
    </tr>
    <tr>
      <td>&nbsp;</td>
