...
function initTranslation()
{
  ...
  e.innerHTML = _("management manNTPFiji");
	...
	e = document.getElementById("checkusername");
	e.innerHTML = _("check_username");
...
function loadfocus()
{
	document.web_login.Loginusername.focus();
}
//-->
</script>
</head>
...
<div class="logo" id="logo"><ul><li class="modelname"> &nbsp;<% getCfgGeneral(1, 'ProductName'); %></li></ul></div>
...
Enter the password and click 'Login'.</li>
  <li class="welcome_text"><font color="#FF0000" id="checkusername">Error : Wrong Password ! Please try again.</font></li>
	<li>
