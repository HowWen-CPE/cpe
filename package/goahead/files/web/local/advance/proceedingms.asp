...
var port = "<% getCfgGeneral(1, "RemoteManagementPort"); %>";
var port1 = "<% getCfgGeneral(1,"https_port"); %>";
var enable = "<% getCfgGeneral(1,"https_enable"); %>";
...
lanip = "<% getCfgGeneral(1, "lan_ipaddr2"); %>";
	if(enable == 1)
	{
		detect.location.href = "https://"+lanip+":"+port1+"/checksysup.asp";
	}
	else
	{
  ...
  <tr>
    <td><table width="100%" height="37" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td background="images/popup_top_center.gif" class="table_title" id="Restart"></td>
