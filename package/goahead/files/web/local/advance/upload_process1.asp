        ...
        <td bgcolor="#FFFFFF"><span class="popupcontent"> 
          <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td width="69%" colspan="2"><span style="font-size:14px; font-weight:bold; color:#990000;"><a id="proceeding_message_3">Firmware Upgrade is proceeding. Please Wait ... </a><br><a id="proceeding_message_5"></a></span></td>
              </tr>
            ...
            <tr>
                    <td height="20" colspan="3" id="proceeding_message_2"></td>
      </tr>
            <tr>
...
{
detect.location.href = '/reboot_detect.asp';
self.setTimeout('refresh_info()', 2000);
}
function initTranslation1()
{
	var e = document.getElementById("proceeding_message_3");
	...
	self.setTimeout('refresh_info()', 30000);
}
self.setTimeout('initTranslation1()', 80000);
</script>	
</html>
