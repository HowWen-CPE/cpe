#ifndef __CONFIG_WP838_H
#define __CONFIG_WP838_H
...
#define WL1_APCLI_RULE "1^GENERIC_AP_5G^^disabled^0^0^0^-85^-95"
...
#define WL0_SSID_RULE "Generic_SSID|Generic_SSID1|Generic_SSID2|Generic_SSID3|Generic_SSID4|Generic_SSID5|Generic_SSID6|Generic_SSID7"
...
#define MANUFACTURER        "vendor's Corp."
#define MANUFACTURERURL     "http://www.vendor.com"
#define MODELDESCRIPTION    "Internet Sharing Gateway"
#define MODELNAME           "Internet Sharing Gateway"
#define MODELNUMBER         ""
#define MODELURL            ""
...
#define LAN_DHCPS_GUESTLAN "default^0^33^32^86400^vendor.com^^ispdns^^^^^none^opendns^opendns^192.168.1.10^24^60"
...
nvram_tuple_t nvram_factory_default[] = {                        
...
#ifdef SINGLE_ETHERNET //single port
	{ "port_device_rule", "eth0^0", 
		NVRAM_NONE,
		0 
	},
#else  //dual port
	{ "port_device_rule", "eth0^2|eth1^3", 
		NVRAM_NONE,
		0 
	},
#endif
	...
	{ "wl0_ap_wmm_rule", WL0_AP_WMM,
		NVRAM_NONE,
		0
	},
	{ "wl1_ap_wmm_rule", WL1_AP_WMM,
		NVRAM_NONE,
		0
	},
	{ "wl0_sta_wmm_rule", WL0_STA_WMM,
		NVRAM_NONE,
		0
	},
	{ "wl1_sta_wmm_rule", WL1_STA_WMM,
		NVRAM_NONE,
		0
	},	
	...
	{ "wl_ap_device_rule", "ath0^ath2^ath4^ath6^ath8^ath10^ath12^ath14|ath1^ath3^ath5^ath7^ath9^ath11^ath13^ath15", 
		NVRAM_NONE,
		0 
	},

	{ "wl_sta_device_rule", "sta0|sta1", 
		NVRAM_NONE,
		0 
	},
